...
export const register = async (req, res)=>{
    ...
    try {
        ...
        res.cookie('token', token, {
            ...
            sameSite: process.env.NODE_ENV === 'production' ? 'none' : 'strict',//if both backend and frontend in same domain strict else none
            maxAge: 7 * 24 * 60 * 60 * 1000 //7d expiry time
        });
        ...
        const mailOptions = {
            ...
            to: email,
            subject: 'Welcome to Remote WorldWide AI platform',
            text: `Welcome to remoteworldwide.ai platform. Your account has been created with email id: ${email}`,
        }
